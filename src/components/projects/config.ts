...
import mintSea from "./../../images/mintSea.png";
...
export const projectsEn: Project[] = [
  {
    name: "mint-sea",
    description: "A multi-chain NFT marketplace enabling users to mint NFTs on Ethereum, Binance Smart Chain, and Polygon. After minting,users can list their NFTs for sale, make offers, and seamlessly withdraw funds to their wallets across supported networks.",
    image: mintSea,
    url: "https://mintsea.netlify.app/",
    github: "",
    technologies: getSkill(["React", "chianlink", "typescript", "css", "solidity", "MongoDB"])
  },
  {
    name: "Cardix",
